...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#0f6b54" },
      { title: "Versleutelde Chat" },
      { name: "description", content: "End-to-end versleutelde chat voor je eigen kring." },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { property: "og:title", content: "Versleutelde Chat" },
      { name: "twitter:title", content: "Versleutelde Chat" },
